...
I've created this "<a href="https://doodle.com/meeting/participate/id/dyXD2WPb" target="_blank">Doodle</a>" to allow you to vote on one of the time slots I have available. If there is enough interest then I can run it twice.

We will be using my Foundry server. Details will follow.
...
That said, if you prefer, you can use a pre-gen character. Let me know on Discord (`colinbate`) if you have any questions.
